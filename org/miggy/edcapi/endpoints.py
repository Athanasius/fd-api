...
###########################################################################
# Our base class for endpoints operations
###########################################################################
class endpoints(object):
  ...
  def get(self, cmdrname: str) -> dict:
    ...
    uri = self.__config.get('capi_url')
    ...
    if response.status_code == 200:
      self.__raw_endpoints = response.text
      self.__endpoints = json.loads(self.__raw_endpoints)
    ...
    return self.__raw_endpoints, self.__endpoints
###########################################################################
