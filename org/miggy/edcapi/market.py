...
###########################################################################
# Our base class for market operations
###########################################################################
class market(object):
  ...
  def get(self, cmdrname: str) -> dict:
    ...
    uri = self.__config.get('capi_url') + '/market'
    ...
    if response.status_code == 200:
      self.__raw_market = response.text
      self.__market = json.loads(self.__raw_market)
    ...
    return (self.__raw_market, self.__market)
###########################################################################
