...
###########################################################################
# Our base class for communitygoals operations
###########################################################################
class communitygoals(object):
  ...
  def get(self, cmdrname: str) -> dict:
    ...
    uri = self.__config.get('capi_url') + '/communitygoals'
    ...
    if response.status_code == 200:
      self.__raw_communitygoals = response.text
      self.__communitygoals = json.loads(self.__raw_communitygoals)
    ...
    return (self.__raw_communitygoals, self.__communitygoals)
###########################################################################
